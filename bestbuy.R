...
url1 <- paste("http://api.remix.bestbuy.com/v1/products(longDescription=iPhone*|sku=7619002)?show=sku,name&pageSize=15&page=5&format=json&apiKey=", BEST_BUY_API_KEY)
url1
